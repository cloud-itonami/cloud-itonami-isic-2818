...
`cloud-itonami-isic-2818` is an OSS open-business blueprint for
power-driven hand tool plant operations coordination.

## Maintainers
Maintainers may merge changes that preserve these invariants:
- a motor-assembly/housing-molding/test-bench-equipment action the governor refuses is never dispatched to hardware.
- the Power-Driven Hand Tool Plant Operations Governor remains independent of the advisor.
...
- bypassing motor-assembly/housing-molding/test-bench-equipment-control or record policy checks
