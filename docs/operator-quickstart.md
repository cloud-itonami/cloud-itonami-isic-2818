# Operator Quickstart — Manufacture of power-driven hand tools

Shortest path from clone to a verified local dry-run for **ISIC 2818** (`cloud-itonami-isic-2818`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2818.git
cd cloud-itonami-isic-2818
```
...
- Blueprint governor key: `power-driven-hand-tool-plant-operations-governor`
- Likely source path: `powertoolmfg.governor.cljc`
