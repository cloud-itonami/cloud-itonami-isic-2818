(ns powertoolmfg.phase
  "Phase 0->3 staged rollout for the power-driven hand tool (drills,
  ...
  consequence (a motor-assembly/housing-molding/test-bench-equipment
  ...
  `powertoolmfg.governor`'s `equipment-actuate-blocked-violations`
...
(defn verdict->disposition
  "Map a Power-Driven Hand Tool Plant Operations Governor verdict to a
