(ns powertoolmfg.registry-test
  (:require [clojure.test :refer [deftest is]]
            [powertoolmfg.registry :as r]))
...
(deftest known-product-types-are-valid
  (doseq [pt [:drill :circular-saw :jigsaw :sander :angle-grinder]]
...
(deftest typical-hipot-test-kv-is-valid
  (is (r/hipot-test-kv-valid? 0.0))
  (is (r/hipot-test-kv-valid? 1.5))
  (is (r/hipot-test-kv-valid? 3.0))
  (is (r/hipot-test-kv-valid? 15.0)))

(deftest negative-hipot-test-kv-is-invalid
  (is (not (r/hipot-test-kv-valid? -1.0))))

(deftest excessive-hipot-test-kv-is-invalid
  (is (not (r/hipot-test-kv-valid? 999999.0)))
  (is (not (r/hipot-test-kv-valid? 15.01))))

(deftest non-numeric-or-missing-hipot-test-kv-is-invalid
  (is (not (r/hipot-test-kv-valid? nil)))
  (is (not (r/hipot-test-kv-valid? "2.5"))))
...
(deftest history-is-append-only
  (let [c1 (r/register-maintenance "mnt-1" "assy-001" 0)
        hist (r/append [] c1)
        c2 (r/register-maintenance "mnt-2" "assy-001" 1)
